...
internal class Ror : IOperation {
    ...
    public int Apply(EmulationState state, Instruction instruction) {
        ...
        if (instruction.AddressingMode is AddressingMode.Accumulator) {
            ...
            Result = (byte)((MemoryValue >> 1) | BitSeven);
